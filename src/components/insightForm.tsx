...
export default function InsightForm(user: User) {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 space-y-10">
      <h1 className="text-3xl font-bold text-center">Tell Us About Yourself {user?.email} </h1>
      ...
      <div className="text-center">
        <Link href={`/profile/${user.id}/output/abcd/v3`} className="px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition">
          Generate My Roadmap
        </Link>
      </div>
    </div>
